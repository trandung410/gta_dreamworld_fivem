...
AddEventHandler("esx:playerLoaded", function(playerId, xPlayer)
	...
	ConnectedPlayers[playerId].source = xPlayer.source
...
AddEventHandler('esx_vangelico_robbery:rob', function(robb)
	...
	local xPlayers = ESX.GetPlayers()
	if xPlayer.job.name ~= 'police' and xPlayer.job.name ~= 'ambulance' and xPlayer.job.name ~= 'mechanic' then
		if Stores[robb] then
		...
		TriggerClientEvent('esx:showNotification', source, "~r~Ngành nghề nhà nước không thể làm việc này!")
	end
end)
