...
Config.maxpickablecoke = 50
Config.MinCokePickUP = 1
Config.MaxCokePickUP = 3
Config.PickupBlip = {x=2448.9228515625, y=-1836.8076171875, z=51.953701019287} -- COKE PICKUP
Config.Processing = {x = 1091.276, y = -3194.787, z = -39.293} -- COKE PROCESS
----------------------------------------------------------------------------------------------

--meth
Config.Enablemeth = true
Config.maxpickablemeth = 50
