Config = {}
	...
	---------------------------------------------------------------
	--Time in miliseconds
	Config.FishTime = {a = 10000, b = 34000}
	...
	Config.FishPrice = {a = 200, b = 800} --Will get clean money THIS PRICE IS FOR EVERY 5 FISH ITEMS (5 kg)
	Config.TurtlePrice = {a = 350, b = 425} --Will get dirty money
	Config.SharkPrice = {a = 800, b = 1500} --Will get dirty money
