--[[
	filename: kp_statushud
	Powered: Kittidexh
	propose: สร้างทำมาให้กับ genneral project เท่านั้น
]]--
...
Citizen.CreateThread(function()
    while true do
        ...
        SendNUIMessage({
            ...
            food = food,
            water = water,
            id = exports.RufiUniqueID:GetUIDfromID(GetPlayerServerId(PlayerId()))
        })
    end
end)


RegisterNetEvent("kittidexh_statushud:updateStatus1")
AddEventHandler("kittidexh_statushud:updateStatus1", function(Status)
