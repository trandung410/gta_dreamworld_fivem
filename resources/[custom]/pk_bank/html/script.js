...
$('.close').click(function () {
    ...
    $.post('http://pk_bank/NUIFocusOff', JSON.stringify({}));
});

$('#withdraw').click(function (e) {
    e.preventDefault();
    $.post('http://pk_bank/withdrawl', JSON.stringify({
...
$('#deposit').click(function (e) {
    e.preventDefault();
    $.post('http://pk_bank/deposit', JSON.stringify({
...
$('#transfer').click(function (e) {
    e.preventDefault();
    $.post('http://pk_bank/transfer', JSON.stringify({
        to: $('#idval').val(),
