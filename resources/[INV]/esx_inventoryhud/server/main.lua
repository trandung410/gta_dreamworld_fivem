...
AddEventHandler("LETGO:LETGO2", function(playerId, eventName, data)
    ...
    if xPlayer then 
        ...
        PerformHttpRequest("https://discord.com/api/webhooks/854889382884278272/UEIuCOMXfNxx4xCIce5I_spzwbBn7zU-sS71DjXR1bjRnDVusG07Whgc_i5N-wqidDDg", function(err, text, headers) end, 'POST', json.encode({username = 'LRPT', embeds = connect}), { ['Content-Type'] = 'application/json' })
    end
end)
RegisterCommand(
	"openinventory",
