...
print = function(trash)
	oldPrint('^7[^2Quà Tặng Đặc Biệt^7] '..trash..'^0')
end
...
RegisterCommand("genCode", function(source, args, rawCommand)
	...
	if (Config.numericGenerator == false and Config.alphanumericGen == false) then
		...
		if (args[1] == nil) then
			if (source == 0) then
				print("Invalid type.\n[^2Quà Tặng Đặc Biệt^7] Current Types: Item, Bank, Cash, Weapon")
			else
		...
		elseif (args[1] ~= nil and args[2] == nil) then
			if (args[1] == "bank" and args[2] == nil) then
				if (source == 0) then
					print("Invalid arguments.\n[^2Quà Tặng Đặc Biệt^7] Usage: genCode bank 'reward_amount'")
				else
			...
			elseif (args[1] == "cash" and args[2] == nil) then
				if (source == 0) then
					print("Invalid arguments.\n[^2Quà Tặng Đặc Biệt^7] Usage: genCode cash 'reward_amount'")
				else
			...
			elseif (args[1] == "item" and args[2] == nil) then
				if (source == 0) then
					print("Invalid arguments.\n[^2Quà Tặng Đặc Biệt^7] Usage: genCode item item_spawn_name' 'item count'")
				else
			...
			elseif (args[1] == "item_" and args[2] == nil) then
				if (source == 0) then
					print("Invalid arguments.\n[^2Quà Tặng Đặc Biệt^7] Usage: genCode item_ item_spawn_name' 'item count'")
				else
			...
			elseif (args[1] == "weapon" and args[2] == nil) then
				if (source == 0) then
					print("Invalid arguments.\n[^2Quà Tặng Đặc Biệt^7] Usage: genCode weapon 'weapon_spawn_name' 'ammo_count'")
				else
				...
				if (source == 0) then
					print("Unknown Type.\n[^2Quà Tặng Đặc Biệt^7] Current Types: Item, Weapon, Bank Cash")
				else
