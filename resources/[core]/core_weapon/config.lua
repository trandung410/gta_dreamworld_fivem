...
Text = {
	...
	['attachment_store_clip_category'] = 'Băng đạn',
	['attachment_store_misc_category'] = 'Misc',
	['attachment_store_attachments_category'] = 'Phụ kiện vũ khí',
	['open_attachment_store'] = '[~r~E~w~] Mở shop phụ kiện',
	['attachment_store_name'] = 'Shop phụ kiện',
	['unsuccessful_purchase'] = 'Bạn không có đủ tiền hoặc không gian trống',
	['successful_purchase'] = 'Bạn đã mua {item}',
	['clip_full'] = 'Băng đạn đã đầy',
	['wrong_clip'] = 'Sai băng đạn',
	['full_armor'] = 'Bạn đã mặc áo giáp',
	['attachment_equipped'] = 'Đã trang bị phụ kiện',
