...
Config.webhook = "https://discord.com/api/webhooks/828168981092630559/8lA7zoKZkuYVwFasfeF9AiePmdEH1aFtHR4V_aJo5DpZ_9Q4uURQZmf5rOYquHg6qRYw"						-- Webhook to send logs to discord
...
Config.gas_station_locations = {
	["gas_station_1"] = {										-- ID
		...
		['sell_price'] = 700000,								-- Price to sell this gas station
...
Config.gas_station_types = {
	['small_gas_station'] = {					-- Gas station type ID
		...
		['ressuply_deliveryman'] = {					-- Driver contracts
			...
			['price_per_liter'] = 2					-- Standard price per contract liter
		},
		['ressuply'] = {								-- Definition of contracts for the owner
			[1] = {
				...
				['price_per_liter_to_export'] = 26,		-- Price per liter to export
		...
		['blips'] = {							-- Create the blips on the map
			...
			['name'] = "<FONT FACE='Montserrat'>Trạm xăng",			-- Blip Name
			['color'] = 41,						-- Blip Color
