	...
	for k,v in pairs(Config.Zones) do
		for i = 1, #v.Pos, 1 do
			if v.CustomBlip then
				...
				AddTextEntry('BLIP_SHOPDIR_1', v.CustomBlip.Text)
				BeginTextCommandSetBlipName("BLIP_SHOPDIR_1")
				...
				if v.ShowBlip == true then
					...
					SetBlipAsShortRange(blip, true)
					AddTextEntry('BLIP_SHOPDIR', "<FONT FACE='Montserrat'>Cửa hàng tiền bẩn")
					BeginTextCommandSetBlipName("BLIP_SHOPDIR")
					EndTextCommandSetBlipName(blip)
				end
			end	
		end
