var config = {
  'title': 'Dream World RP',
  'welcomeMessage': 'WELCOME TO DREAM WORLD 2021',
  ...
  'discord': {
    'show': true,
    'discordLink': 'https://discord.gg/TvCjBqQz4W',
  },
...
var announcements = [
  'Liên hệ Anh Già , để tìm niềm vui!',
]


// Add/Modify rules below.
var guidelines = [
  'Những cá nhân nào sử dụng phần mềm thứ 3 , bug , hack sẽ bị BAN thẳng tay.',
  'Cấm tuyệt đối những hành vi scam , nếu phát hiện hành vi bị scam sẽ BAN thẳng tay + admin không chịu trách nhiệm.',
  'Lấy xe tông người chơi (CRM),giết người,camp xác ngoài vùng đỏ hoặc trong lãnh địa nhà gang không lý do sẽ quy vào tội NONRP,nếu trường hợp nặng sẽ BAN vĩnh viễn.',
  'Xúc phạm người chơi , phân biệt vùng miền hoặc vi phạm đời tư của người khác sẽ ăn sẹo server.',
]
