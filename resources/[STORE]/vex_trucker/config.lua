...
Config.webhook = "https://discord.com/api/webhooks/828169103558443008/5ZFMzWAJlX6tZMAC1pFdYt06oGoRkCTC5pjJIxDSV3ocFcChzy1526RXSNSozapr3F1O"					-- Webhook to send logs to discord
...
Config.contratos = {
	...
	['preco_por_km_min'] = 1000,				-- Minimum price per kilometer of the contract1111111111111111111111111111
	['preco_por_km_max'] = 3000,				-- Maximum price per kilometer of the contract11111111111111111111111111111111
...
Config.motoristas = {
	...
	['preco_por_km_min'] = 2000,					-- Minimum starting price per KM of the driver (at the end of each delivery)1111111111111111111111111
	['preco_por_km_max'] = 4000,					-- Maximum initial price per KM of the driver (at the end of each delivery)111111111111111111111
	['preco_min'] = 2000,						-- Minimum initial price of the driver (at the end of each delivery)
	['preco_max'] = 2100,						-- Maximum initial price of the driver (at the end of each delivery)
...
Config.trabalhos = {
	...
	['valor_inicial_min'] = 1000,			-- Minimum initial contract profit
	['valor_inicial_max'] = 3000,			-- Maximum initial contract profit
...
Config.blips = {
	{1208.7109375,-3114.9431152344,5.7480750083923,478,4,"<FONT FACE='Montserrat'>Lái xe tải",0.5 },
}