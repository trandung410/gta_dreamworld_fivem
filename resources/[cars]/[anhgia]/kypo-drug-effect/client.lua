...
AddEventHandler('kypo-drug-effect:onCoke', function()
  ...
  local playerPed = PlayerPedId()
    ...
    exports['mythic_notify']:DoHudText('success', 'Bạn đã sử dụng cocain!')
...
AddEventHandler('kypo-drug-effect:onWeed', function()
  ...
  local playerPed = PlayerPedId()
    ...
    exports['mythic_notify']:DoHudText('success', 'Bạn đang bú cần !')
    TaskStartScenarioInPlace(playerPed, "WORLD_HUMAN_SMOKING_POT", 0, 1)
    Citizen.Wait(3000)
    ClearPedTasksImmediately(playerPed)
...
AddEventHandler('kypo-drug-effect:onHeroin', function()
  ...
  local playerPed = PlayerPedId()
    ...
    exports['mythic_notify']:DoHudText('success', 'Bạn đã hít Heroin!')
    TaskStartScenarioInPlace(playerPed, "WORLD_HUMAN_SMOKING_POT", 0, 1)
    Citizen.Wait(3000)
    ClearPedTasksImmediately(playerPed)
