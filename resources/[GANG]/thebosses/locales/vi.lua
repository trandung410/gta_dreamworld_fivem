Locales['vi'] = {
  ...
  ['gang1_wear'] = 'Đồng phục Gang',
  ['commandant_wear'] = 'Skin gang',
  ...
  ['player_cannot_hold'] = 'Túi đồ bạn không đủ',
  -- Misc
  ['remove_object'] = 'press ~INPUT_CONTEXT~ to delete the object',
  ['map_blip'] = '<FONT FACE="Montserrat">~p~[GANG] ~p~The Bosses',
  -- Notifications
  ['from'] = '~s~ from ~b~',
