...
ESX.ShowNotification = function(msg, flash, saveToBrief, hudColorIndex)
	...
	AddTextEntry('esxNotification', "<FONT FACE='Montserrat'>"..msg)
...
ESX.ShowAdvancedNotification = function(sender, subject, msg, textureDict, iconType, flash, saveToBrief, hudColorIndex)
	if saveToBrief == nil then saveToBrief = true end
	AddTextEntry('esxAdvancedNotification', "<FONT FACE='Montserrat'>"..msg)
	BeginTextCommandThefeedPost('esxAdvancedNotification')
	if hudColorIndex then ThefeedNextPostBackgroundColor(hudColorIndex) end
	EndTextCommandThefeedPostMessagetext(textureDict, textureDict, false, iconType, "<FONT FACE='Montserrat'>"..sender, subject)
	EndTextCommandThefeedPostTicker(flash or false, saveToBrief)
end

ESX.ShowHelpNotification = function(msg, thisFrame, beep, duration)
	AddTextEntry('esxHelpNotification', "<FONT FACE='Montserrat'>"..msg)
...
ESX.Game.GetVehicleProperties = function(vehicle)
	...
	return {
		...
		xenonLightColor = table.pack(GetVehicleXenonLightsColour(vehicle)),
...
ESX.Game.SetVehicleProperties = function(vehicle, props)
	...
	if props.customColorPrimary ~= nil then
		SetVehicleCustomPrimaryColour(vehicle, props.customColorPrimary[1], props.customColorPrimary[2], props.customColorPrimary[3])
	end
	if props.customColorSecondary ~= nil then
		SetVehicleCustomSecondaryColour(vehicle, props.customColorSecondary[1], props.customColorSecondary[2], props.customColorSecondary[3])
	end
		
		
	if props.xenonLightColor ~= nil then
		SetVehicleXenonLightsColour(vehicle, props.xenonLightColor[1], props.xenonLightColor[2], props.xenonLightColor[3])
	end
...
Citizen.CreateThread(function()
	...
	ESX.FontId = RegisterFontId('Montserrat')
	AddTextEntry('STRING', "<FONT FACE='Montserrat'>~a~</FONT>")
	AddTextEntry('CUSTOM_STRING', "<FONT FACE='Montserrat'>~a~</FONT>")
	while true do
		Citizen.Wait(0)
