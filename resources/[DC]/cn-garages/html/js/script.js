...
$(document).on("click", "#button", function (e) {
    ...
    if (btnType == "park") {
        ...
        if (currentType == 'garages') {
            $.post("https://cn-garages/payout", JSON.stringify({
                    garage: activeGarage,
        ...
        $.post("https://cn-garages/waypoint", JSON.stringify({
            name: btnName,
            type: btnType,
        }));
        ...
        setTimeout(() => { 
            ...
            $.post("https://cn-garages/vehicleblip", JSON.stringify({
                plate: btnPlate,
        }));
        }, 2000);
    }
