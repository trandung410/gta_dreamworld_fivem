...
function DrawMissionText(msg, time)
	ClearPrints()
	BeginTextCommandPrint('CUSTOM_STRING')
...
function StartDriveTest(type)
	...
	RequestModel(GetHashKey("wave125i"))
...
function StopDriveTest(success)
	if success then
			...
			ESX.Game.SpawnVehicle('wave125i', coords, heading, function(vehicle)
				TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
				...
				TriggerServerEvent('8a48f1e3-0abf-4d9b-8a7b-5db42ca0e348', vehicleProps)
				
				ESX.ShowNotification('đã nhận được một chiếc xe free, bạn có thể lấy tại gara màu CAM,Nhà Xe Thất Lạc ')
			end)
