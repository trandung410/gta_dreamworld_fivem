...
RegisterServerEvent('discordbot:delcargarage')
AddEventHandler('discordbot:delcargarage', function (plate)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent("discordbot:delcargarage_cl", source,plate)
end)

RegisterServerEvent('discordbot:addcargarage')
AddEventHandler('discordbot:addcargarage', function (plate)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent("discordbot:addcargarage_cl", source,plate)
end)

RegisterServerEvent('discordbot:poundcargarage')
AddEventHandler('discordbot:poundcargarage', function (plate)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent("discordbot:poundcargarage_cl", source,plate)
end)