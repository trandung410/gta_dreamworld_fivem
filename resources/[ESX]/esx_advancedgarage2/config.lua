...
Config.PolicePounds = {
	...
	Pound_Paleto1 = {
		PoundPoint = { x = 232.6988067627, y = -816.23846435547, z =30.303869247437 -0.9},
		SpawnPoint = { x = 231.31643676758, y = -799.81945800781, z =30.547904968262, h = 150.73 }
	},
	Pound_Paleto2 = {
		PoundPoint = { x = 873.20629882812, y = -59.307888031006, z =78.764030456543 -0.9 },
		SpawnPoint = { x = 880.86029052734, y = -47.152908325195, z =78.764030456543, h = 152.23 }
	},
	Pound_Paleto3 = {
		PoundPoint = { x = 1832.5080566406, y = 2542.1989746094, z =45.880599975586 -0.9 },
		SpawnPoint = { x = 1832.5080566406, y = 2542.1989746094, z =45.880599975586, h = 263.73 }
	},
}
...
Config.CarGarages = {
	Garage_CentralLS = {
		GaragePoint = { x = 231.47325134277, y = -799.74145507812, z =30.545845031738 -1 },
...
Config.CarPounds = {
	...
	Pound_GarageTT = {
		PoundPoint = { x = 215.800, y = -810.057, z = 29.727 },
		SpawnPoint = { x = 229.700, y = -800.1149, z = 29.5722, h = 157.84 }
	},
