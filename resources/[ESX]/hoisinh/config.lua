...
mechPeds = {
                ...
                [1] = {name = "<FONT FACE = 'Tahoma'>Bác sĩ Black Wolf Server", icon = "CHAR_CALL911", model = "yasuo", vehicle = 'faggio', colour = 111, 
                                ['lines'] = {"<FONT FACE = 'Tahoma'>Hasagiiiiiiiiiii.",}},--s_m_m_doctor_01
