...
function OpenPersonnelMenu()
	...
	--[[	if (IsInVehicle()) then
			...
			if ( GetPedInVehicleSeat( vehicle, -1 ) == GetPlayerPed(-1) ) then
				table.insert(elements, {label = 'เมนูรถ',					value = 'menuperso_vehicule'})
			end
		end ]]--
				
		if playergroup == 'mod' or playergroup == 'admin' or playergroup == 'superadmin' or playergroup == 'owner' then
			table.insert(elements, {label = 'SUPERADMIN',				value = 'menuperso_modo'})
		end
		...
		ESX.UI.Menu.Open(
			...
			function(data, menu)
				...
				if playergroup == 'mod' then
					table.insert(elements, {label = 'Goto',    							value = 'menuperso_modo_tp_toplayer'})
					table.insert(elements, {label = 'Bring',             			value = 'menuperso_modo_tp_playertome'})
					table.insert(elements, {label = 'TP POS',						value = 'menuperso_modo_tp_pos'})
					table.insert(elements, {label = 'NoClip',										value = 'menuperso_modo_no_clip'})
				--	table.insert(elements, {label = 'โหมดอมตะ',									value = 'menuperso_modo_godmode'})
					table.insert(elements, {label = 'โหมดล่องหน',								value = 'menuperso_modo_mode_fantome'})
				--	table.insert(elements, {label = 'ซ่อมรถ',							value = 'menuperso_modo_vehicle_repair'})
				--	table.insert(elements, {label = 'เสกรถ',							value = 'menuperso_modo_vehicle_spawn'})
				--	table.insert(elements, {label = 'Flip รถ',								value = 'menuperso_modo_vehicle_flip'})
				--	table.insert(elements, {label = 'ให้เงิน',						value = 'menuperso_modo_give_money'})
				--	table.insert(elements, {label = 'ให้เงินธนาคาร',						value = 'menuperso_modo_give_moneybank'})
				--	table.insert(elements, {label = 'ให้เงินผิดกฎหมาย',						value = 'menuperso_modo_give_moneydirty'})
				--	table.insert(elements, {label = 'แสดงตำแหน่ง',		value = 'menuperso_modo_showcoord'})
					table.insert(elements, {label = 'Showname',	value = 'menuperso_modo_showname'})
				--	table.insert(elements, {label = 'TP sur le marqueur',							value = 'menuperso_modo_tp_marcker'})
				--	table.insert(elements, {label = 'เพิ่มเลือด',					value = 'menuperso_modo_heal_player'})
					table.insert(elements, {label = 'Spec',						value = 'menuperso_modo_spec_player'})
				--	table.insert(elements, {label = 'เปลี่ยนชุด',									value = 'menuperso_modo_changer_skin'})
				--	table.insert(elements, {label = 'Save สกิน',									value = 'menuperso_modo_save_skin'})
				end
				...
				if playergroup == 'admin' then
					...
					table.insert(elements, {label = 'TP POS',						value = 'menuperso_modo_tp_pos'})
					table.insert(elements, {label = 'NoClip',										value = 'menuperso_modo_no_clip'})
					table.insert(elements, {label = 'godmod',									value = 'menuperso_modo_godmode'})
					table.insert(elements, {label = 'TH',								value = 'menuperso_modo_mode_fantome'})
					table.insert(elements, {label = 'Repair',							value = 'menuperso_modo_vehicle_repair'})
					table.insert(elements, {label = 'Spawn',							value = 'menuperso_modo_vehicle_spawn'})
					table.insert(elements, {label = 'Flip vehicle',								value = 'menuperso_modo_vehicle_flip'})
				--	table.insert(elements, {label = 'ให้เงิน',						value = 'menuperso_modo_give_money'})
				--	table.insert(elements, {label = 'ให้เงินธนาคาร',						value = 'menuperso_modo_give_moneybank'})
				--	table.insert(elements, {label = 'ให้เงินผิดกฎหมาย',						value = 'menuperso_modo_give_moneydirty'})
				--	table.insert(elements, {label = 'แสดงตำแหน่ง',		value = 'menuperso_modo_showcoord'})
					table.insert(elements, {label = 'Showname',	value = 'menuperso_modo_showname'})
				--	table.insert(elements, {label = 'TP sur le marqueur',							value = 'menuperso_modo_tp_marcker'})
					table.insert(elements, {label = 'Heal',					value = 'menuperso_modo_heal_player'})
					table.insert(elements, {label = 'Spec',						value = 'menuperso_modo_spec_player'})
				...
				if playergroup == 'superadmin' or playergroup == 'owner' then
					...
					table.insert(elements, {label = 'Godmod',									value = 'menuperso_modo_godmode'})
					table.insert(elements, {label = 'TH',								value = 'menuperso_modo_mode_fantome'})
					table.insert(elements, {label = 'Repair V',							value = 'menuperso_modo_vehicle_repair'})
					table.insert(elements, {label = 'Spawn V',							value = 'menuperso_modo_vehicle_spawn'})
					table.insert(elements, {label = 'Flip V',								value = 'menuperso_modo_vehicle_flip'})
					table.insert(elements, {label = 'Givemoney',						value = 'menuperso_modo_give_money'})
					table.insert(elements, {label = 'GiveBank',						value = 'menuperso_modo_give_moneybank'})
					table.insert(elements, {label = 'GiveDirtyM',						value = 'menuperso_modo_give_moneydirty'})
					table.insert(elements, {label = 'Showcoord',		value = 'menuperso_modo_showcoord'})
					table.insert(elements, {label = 'Showname',	value = 'menuperso_modo_showname'})
					table.insert(elements, {label = 'TPM',							value = 'menuperso_modo_tp_marcker'})
					table.insert(elements, {label = 'Heal',					value = 'menuperso_modo_heal_player'})
					table.insert(elements, {label = 'Spec',						value = 'menuperso_modo_spec_player'})
					table.insert(elements, {label = 'Change Skin',									value = 'menuperso_modo_changer_skin'})
					table.insert(elements, {label = 'Save Skin',									value = 'menuperso_modo_save_skin'})
				...
				if data.current.value == 'menuperso_moi' then
					...
					table.insert(elements, {label = 'Phone',    							value = 'menuperso_moi_telephone'})
				...
				if data.current.value == 'menuperso_grade' then
					ESX.UI.Menu.Open(
						'default', GetCurrentResourceName(), 'menuperso_grade',
						{
							...
							align    = 'top-left',
							elements = {
								{label = 'แอดยศ',     value = 'menuperso_grade_recruter'},
								{label = 'Virer',              value = 'menuperso_grade_virer'},
								{label = 'เลื่อนขั้น', value = 'menuperso_grade_promouvoir'},
						...
						function(data2, menu2)
							...
							if data2.current.value == 'menuperso_grade_recruter' then
								if PlayerData.job.grade_name == 'boss' then
									...
									if closestPlayer == -1 or closestDistance > 3.0 then
										ESX.ShowNotification("คุณได้รับเข้างานแล้ว")
									else
							...
							if data2.current.value == 'menuperso_grade_virer' then
								if PlayerData.job.grade_name == 'boss' then
										...
										local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
									if closestPlayer == -1 or closestDistance > 3.0 then
										ESX.ShowNotification("คุณได้เลื่อนขั้นแล้ว")
									else
...
function OpenVehiculeMenu()
	...
	if vehiculeON then
		table.insert(elements, {label = 'เปิดเครื่อง',			value = 'menuperso_vehicule_MoteurOff'})
	else
		table.insert(elements, {label = 'ปิดเครื่อง',		value = 'menuperso_vehicule_MoteurOn'})
	end
...
function admin_godmode()
  ...
  if godmode then -- activé
		SetEntityInvincible(ped, true)
		Notify("Mode invincible ~g~ Active")
	else
		SetEntityInvincible(ped, false)
		Notify("Mode invincible ~r~ Disactive")
  end
end
-- FIN GOD MODE
...
function admin_mode_fantome()
  ...
  if invisible then -- activé
		SetEntityVisible(ped, false, false)
		Notify("Mode Fantom : active")
	else
		SetEntityVisible(ped, true, false)
		Notify("Mode Fantom: disactive")
  end
end
-- FIN INVISIBLE
