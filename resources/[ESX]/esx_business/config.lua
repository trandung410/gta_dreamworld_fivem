...
Config.display = {
    ...
    {offset = -0.1, text = "~b~Chủ sở hữu: ~r~{owner_rp_name} ~b~Giá trị công ty: ~g~${price} ~s~(~r~{taxrate}% thuế~s~)", scale = 1},
    {offset = -0.21, text = "~b~Doanh thu: ~g~${earnings}/hr", scale = 1}
}

Config.blip = {
    enabled = true,
    color = 49, -- https://wiki.gtanet.work/index.php?title=Blips
    sprite = 491, -- https://wiki.gtanet.work/index.php?title=Blips
    name = "Business"
}
