...
Config.DamageMult = 1.25 -- Higher Number = Higher Repair Price.
...
Config.PolicePounds = {
	Pound_CentralLS = {
		PoundPoint = { x = 241.87, y = -808.88, z = 29.24 },
		SpawnPoint = { x = 229.700, y = -800.1149, z = 29.5722, h = 157.84 }
	},
	Pound_Sandy = {
		PoundPoint = { x = 1745.0, y = 3713.11, z = 33.15 },
		SpawnPoint = { x = 1737.84, y = 3719.28, z = 33.04, h = 21.22 }
	},
	Pound_Paleto = {
		PoundPoint = { x = 111.47, y = 6602.11, z = 30.95 },
		SpawnPoint = { x = 126.3572, y = 6608.4150, z = 30.8565 }
	},
	Pound_Prison = {
		PoundPoint = { x = 1853.33, y = 2567.64, z = 44.67 },
		SpawnPoint = { x = 1855.11, y = 2592.72, z = 44.67, h = 274.8 }
	},
	Pound_CarCasino = {
		PoundPoint = { x = 871.35, y = -33.07, z = 77.76 },
		SpawnPoint = { x = 1855.11, y = 2592.72, z = 44.67, h = 274.8 }
	},
	Pound_9h = {
		PoundPoint = { x = -3138.23, y = 1094.71, z = 19.64 },
		SpawnPoint = { x = -3144.25, y = 1110.23, z = 20.7, h = 270.42 }
	}
...
Config.CarGarages = {
	...
	Garage_Prison = {
		GaragePoint = { x = 1852.20, y = 2586.05, z = 45.67-0.9 },
		SpawnPoint = { x = 1855.11, y = 2592.72, z = 44.67, h = 274.8 },
	...
	Garage_9h = {
		GaragePoint = { x = -3148.94, y = 1100.05, z = 19.71 },
		SpawnPoint = { x = -3144.25, y = 1110.23, z = 20.7, h = 270.42 },
		DeletePoint = { x = -3139.09, y = 1124.51, z = 19.7}
	}
}

Config.CarPounds = {
	 Pound_CentralLS = {
		PoundPoint = { x = 234.11, y = -817.02, z = 29.26 },
		SpawnPoint = {  x = 229.700, y = -800.1149, z = 29.5722, h = 157.84 }
	},
	Pound_Sandy = {
		PoundPoint = { x = 1741.44, y = 3711.8, z = 33.15 },
		SpawnPoint = { x = 1737.84, y = 3719.28, z = 33.04, h = 21.22 }
	},
	Pound_Paleto = {
		PoundPoint = { x = 106.58, y = 6606.79, z = 30.8 },
		SpawnPoint = { x = 128.7822, y = 6622.9965, z = 30.7828, h = 315.01 }
	},
	Pound_Prison = {
		PoundPoint = { x = 1853.44, y = 2578.63, z = 44.67 },
		SpawnPoint = { x = 1855.11, y = 2592.72, z = 44.67, h = 274.8 }
	},
	Pound_CarCasino = {
		PoundPoint = { x = 867.8, y = -38.85, z = 77.76 },
		SpawnPoint = { x = 1855.11, y = 2592.72, z = 44.67, h = 274.8 }
	},
	Pound_9h = {
		PoundPoint = { x = -3136.72, y = 1102.65, z = 19.65 },
		SpawnPoint = { x = -3144.25, y = 1110.23, z = 20.7, h = 270.42 }
	}
...
Config.PrivateCarGarages = {
	...
	Garage_MedEndApartment8 = {
		...
		SpawnPoint = { x = -377.97, y = 6183.73, z = 30.95, h = 223.71 },
		DeletePoint = { x = -383.31, y = 6188.85, z = 30.95 }
	},
