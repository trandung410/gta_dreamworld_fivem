Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to drill the ~y~Rock~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~y~Rock~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Rock~s~.',
  ['weed_processingstarted'] = 'processing ~g~Rock~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~Rock~s~ in order to process.',
