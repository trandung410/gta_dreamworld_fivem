...
Citizen.CreateThread(function()
	while true do
		...
		if actionsRemaining > 0 and isSentenced then
			draw2dText( _U('remaining_msg', ESX.Math.Round(actionsRemaining)), { 0.168, 0.915 } )	
...
function DisplayHelpText(str)
	...
	AddTextComponentString('<FONT FACE="Montserrat">'.. str .. '</FONT>')
