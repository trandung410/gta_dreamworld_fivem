...
Config.TruckPrice	= 500     -- old config from orginal script not used in this version.
Config.Locale       = 'en'
Config.BagPay       = 500     -- Pay per bag pulled from bin.
...
-------------------------------------------Los Santos
	...
	-- blainecounty
	Delivery3LS = {
			Pos   = {x = -1.8858588933945, y = -1729.5538315078, z = 29.150233840942},
			Color = {r = 204, g = 204, b = 0},
			Size  = {x = 5.0, y = 5.0, z = 3.0},
			Color = {r = 204, g = 204, b = 0},
			Type  = 1,
