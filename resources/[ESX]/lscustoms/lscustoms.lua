...
local garages = { 
	...
	-- [2] = { locked = false, camera = {x = -211.08, y = -1323.21, z = 29.89, heading = 114.86}, driveout = {x = 725.46,y = -1088.822, z = 21.455, heading = 89.395}, drivein = {x = 726.157, y = -1088.768, z = 22.169, heading = 270.288}, outside = {x = 716.54,y = -1088.757, z = 21.651, heading = 89.248}, inside = {x = 733.69,y = -1088.74, z = 21.733, heading = 270.528}},
	[2] = { locked = false, camera = {x = -1154.902, y = -2011.438, z = 13.18, heading = 95.49}, driveout = {x = -1150.379,y = -1995.845, z = 12.465, heading = 313.594}, drivein = {x = -1150.26,y = -1995.642, z = 12.466, heading = 136.859}, outside = {x = -1140.352,y = -1985.89, z = 12.45, heading = 314.406}, inside = {x = -1155.077,y = -2006.61, z = 12.465, heading = 162.58}},
	[3] = { locked = false, camera = {x = 1177.98, y = 2636.059, z = 37.754, heading = 37.082}, driveout = {x = 1175.003,y = 2642.175, z = 37.045, heading = 0.759}, drivein = {x = 1174.701,y = 2643.764, z = 37.048, heading = 178.119}, outside = {x = 1175.565,y = 2652.819, z = 37.941, heading = 351.579}, inside = {x = 1174.823,y = 2637.807, z = 37.045, heading = 181.19}},
	[4] = { locked = false, camera = {x = 105.825, y = 6627.562, z = 31.787, heading = 266.692}, driveout = {x = 112.326,y = 6625.148, z = 31.073, heading = 224.641}, drivein = {x = 112.738,y = 6624.644, z = 31.072, heading = 44.262}, outside = {x = 118.493,y = 6618.897, z = 31.13, heading = 224.701}, inside = {x = 108.842,y = 6628.447, z = 31.072, heading = 45.504}},
	[5]= { locked = false, camera = {x = -215.518, y = -1329.135, z = 30.89, heading = 329.092}, driveout = {x = -205.935,y = -1316.642, z = 30.176, heading = 356.495}, drivein = {x = -205.626,y = -1314.99, z = 30.247, heading = 179.395}, outside = {x = -205.594,y = -1304.085, z = 30.614, heading = 359.792}, inside = {x = -212.368,y = -1325.486, z = 30.176, heading = 141.107} }
}
		...
		if LSC_Config.prices.mods[mod].startprice then
			...
			for i = 0,   tonumber(GetNumVehicleMods(veh,mod)) -1 do
				...
				if lbl ~= nil then
					...
					--if mname ~= "NULL" then
						local btn = m:addPurchase(lbl,price)
						btn.modtype = mod
						btn.mod = i
...
local function drawTxt(text,font,centre,x,y,scale,r,g,b,a)
	...
	SetTextEntry("STRING")
	AddTextComponentString('<FONT FACE="Montserrat">'..text)
	DrawText(x , y)	
end
				...
				if DoesEntityExist(veh) and GetPedInVehicleSeat(veh, -1) == ped and (IsThisModelACar(GetEntityModel(veh)) or IsThisModelABike(GetEntityModel(veh)))  then
					...
					for i,pos in ipairs(garages) do
						...
						if LSC_Config.oldenter then			
							...
							if GetDistanceBetweenCoords(outside.x,outside.y,outside.z,GetEntityCoords(ped)) <= 5.0 then
								...
								if IsVehicleDamaged(veh) then 
									drawTxt("Nhấn ~b~ENTER~w~ để ~b~sửa xe trước khi độ",4,1,0.5,0.8,1.0,255,255,255,255)
									if IsControlJustPressed(1,201) then
										ESX.TriggerServerCallback("lscustom:callback:fixVehicle", function(canFix)
											if canFix then 
												SetVehicleFixed(veh)
											else
												ESX.ShowNotification('Không đủ 5.000$ để sửa xe')
											end
										end)
									end
								else
									if IsControlJustPressed(1,201) then
										...
										drawTxt("Nhấn ~b~ENTER~w~ để ~b~độ xe",4,1,0.5,0.8,1.0,255,255,255,255)
									end
								end
								--[[ if IsControlJustPressed(1,201) then
...
local function AddBlips()
	for i,pos in ipairs(garages) do
		...
		AddTextComponentString("<FONT FACE='Montserrat'>Khu vực độ xe")
