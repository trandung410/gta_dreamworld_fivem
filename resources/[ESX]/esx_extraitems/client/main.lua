		...
		if not isBusy then 
			...
			--[[ ESX.Game.SpawnObject('', {
				...
				ESX.Game.SpawnObject('', {
					...
					--AttachEntityToEntity(object2, playerPed, boneIndex2, -0.30, -0.22, 0.0, 0.0, 90.0, 180.0, true, false, false, true, 1, true)
					--AttachEntityToEntity(object, playerPed, boneIndex, 0.0, 0.0, 0.0, 0.0, 90.0, 180.0, true, false, false, true, 1, true)
					SetPedDiesInWater(playerPed, false)				
					Citizen.Wait(200000)
					SetPedDiesInWater(playerPed, true)
					--DeleteObject(object)
...
RegisterNetEvent('esx_extraitems:hoithanhphu')
AddEventHandler('esx_extraitems:hoithanhphu', function()
	local ped = GetPlayerPed(-1)
	ESX.Game.Teleport(ped, {x = 223.27795410156,y = -805.55053710938,z = 30.643775939941, heading = 100.0}, function()
	end)
end)
