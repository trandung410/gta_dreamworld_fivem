...
--hoi thanh phu
ESX.RegisterUsableItem('hoithanhphu', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent('esx_extraitems:hoithanhphu', source)
	xPlayer.removeInventoryItem('hoithanhphu', 1)
end)
--the doi tern
ESX.RegisterUsableItem('rename', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerEvent('esx_identity:register', xPlayer)
	xPlayer.removeInventoryItem('rename', 1)
end)
--the tang trong luong
ESX.RegisterUsableItem('extraweight', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	xPlayer.addMaxWeight(1000)
	xPlayer.removeInventoryItem('extraweight', 1)
end)